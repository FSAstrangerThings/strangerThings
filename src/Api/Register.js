    ...
    return (
        ...
        <div>
            <form id="register" onSubmit={e => {
                ...
                <input type="text" onChange={(event) => setUsername(event.target.value)} value={username} placeholder="username" required />
                <input type="text" onChange={(event) => setPassword(event.target.value)} value={password} placeholder="password" required minLength="8" />
